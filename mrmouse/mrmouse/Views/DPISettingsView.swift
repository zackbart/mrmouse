    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            .onChange(of: sliderValue) {
                appState.setDPI(Int(sliderValue))
            }
        ...
        .onChange(of: currentDPI) { sliderValue = Double(currentDPI) }
        .onChange(of: appState.selectedDeviceID) { sliderValue = Double(currentDPI) }
    }
